  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        bool isWideLayout = constraints.maxWidth > 1200;
        bool isNarrowLayout = constraints.maxWidth > 600 && constraints.maxWidth <= 1200;
        bool isSmallLayout = constraints.maxWidth <= 600;
        double leftPadding = isWideLayout ? 132 : (isNarrowLayout ? 66 : 33);
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                Padding(
                  padding: EdgeInsets.only(left: leftPadding, top: isWideLayout ? 30 : (isNarrowLayout ? 20 : 10)),
                  child: Text(
                ...
                if (isSmallLayout)
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: leftPadding, top: isWideLayout ? 76 : (isNarrowLayout ? 30: 15)),
                    child: Button(
